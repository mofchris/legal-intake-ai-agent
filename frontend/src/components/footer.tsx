...
const footerLinks: FooterSection[] = [
  {
    ...
    links: [
      ...
      { title: "Try the demo", href: "/app", to: "/app" },
    ],
  },
  {
    label: "Company",
    ...
    >
      ...
      <div className="grid w-full gap-8 py-6 md:py-8 lg:grid-cols-3 lg:gap-8">
        <AnimatedContainer className="space-y-4">
          ...
          <p className="mt-8 max-w-xs text-muted-foreground text-sm md:mt-0">
            AI-powered intake automation for personal injury law firms.
          </p>
          <p className="text-muted-foreground text-xs">Portfolio demo — does not provide legal advice.</p>
        </AnimatedContainer>
      ...
      <div className="flex w-full items-center justify-center py-4">
        <p className="text-muted-foreground text-sm">
          &copy; {new Date().getFullYear()} Legal Intake AI. All rights reserved.
        </p>
      </div>
    </footer>
  );
